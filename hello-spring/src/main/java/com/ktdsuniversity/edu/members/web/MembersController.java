...
//		return "redirect:/login";
	...
	public String viewMemberDetailPage(@PathVariable String email, Model model) {
		...
		MembersVO resultVO =  this.membersService.findMemberByEmail(email);
	...
	public String viewMembersListPage(Model model) {
		...
		SearchResultVO searchResult = this.membersService.findMembersAll();
		
		model.addAttribute("count", searchResult.getCount());
		model.addAttribute("members", searchResult.getMembersVO());
